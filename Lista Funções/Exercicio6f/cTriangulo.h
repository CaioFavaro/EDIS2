//Escreva um procedimento que recebes 3 valores reais X, Y e Z e que verifique se esses valores
...
//dos outros dois lados. O procedimento deve identificar o tipo de triângulo formado observando as
...
public:
    ...
    virtual ~cTriangulo();
    void lerDados();
    float conta(float x, float y, float z);
private:
